// ======================================================================
// AQUADOC.v generated from TopDesign.cysch
// 03/25/2019 at 12:13
...
module top ;
    ...
    Timer_v2_80_0 sys_timer (
        ...
        .tc(Net_7),
        .clock(Net_10));
    defparam sys_timer.CaptureCount = 2;
    defparam sys_timer.CaptureCounterEnabled = 0;
    defparam sys_timer.DeviceFamily = "PSoC5";
    defparam sys_timer.InterruptOnCapture = 0;
    defparam sys_timer.InterruptOnTC = 1;
    defparam sys_timer.Resolution = 16;
    defparam sys_timer.SiliconRevision = "0";
