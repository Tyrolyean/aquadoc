...
/* ISR_1m */
#define ISR_1m__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define ISR_1m__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define ISR_1m__INTC_MASK 0x01u
#define ISR_1m__INTC_NUMBER 0u
#define ISR_1m__INTC_PRIOR_NUM 7u
#define ISR_1m__INTC_PRIOR_REG CYREG_NVIC_PRI_0
#define ISR_1m__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define ISR_1m__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* LED_OUT */
#define LED_OUT__0__INTTYPE CYREG_PICU2_INTTYPE7
#define LED_OUT__0__MASK 0x80u
#define LED_OUT__0__PC CYREG_PRT2_PC7
#define LED_OUT__0__PORT 2u
#define LED_OUT__0__SHIFT 7u
#define LED_OUT__AG CYREG_PRT2_AG
#define LED_OUT__AMUX CYREG_PRT2_AMUX
#define LED_OUT__BIE CYREG_PRT2_BIE
#define LED_OUT__BIT_MASK CYREG_PRT2_BIT_MASK
#define LED_OUT__BYP CYREG_PRT2_BYP
#define LED_OUT__CTL CYREG_PRT2_CTL
#define LED_OUT__DM0 CYREG_PRT2_DM0
#define LED_OUT__DM1 CYREG_PRT2_DM1
#define LED_OUT__DM2 CYREG_PRT2_DM2
#define LED_OUT__DR CYREG_PRT2_DR
#define LED_OUT__INP_DIS CYREG_PRT2_INP_DIS
#define LED_OUT__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU2_BASE
#define LED_OUT__LCD_COM_SEG CYREG_PRT2_LCD_COM_SEG
#define LED_OUT__LCD_EN CYREG_PRT2_LCD_EN
#define LED_OUT__MASK 0x80u
#define LED_OUT__PORT 2u
#define LED_OUT__PRT CYREG_PRT2_PRT
#define LED_OUT__PRTDSI__CAPS_SEL CYREG_PRT2_CAPS_SEL
#define LED_OUT__PRTDSI__DBL_SYNC_IN CYREG_PRT2_DBL_SYNC_IN
#define LED_OUT__PRTDSI__OE_SEL0 CYREG_PRT2_OE_SEL0
#define LED_OUT__PRTDSI__OE_SEL1 CYREG_PRT2_OE_SEL1
#define LED_OUT__PRTDSI__OUT_SEL0 CYREG_PRT2_OUT_SEL0
#define LED_OUT__PRTDSI__OUT_SEL1 CYREG_PRT2_OUT_SEL1
#define LED_OUT__PRTDSI__SYNC_OUT CYREG_PRT2_SYNC_OUT
#define LED_OUT__PS CYREG_PRT2_PS
#define LED_OUT__SHIFT 7u
#define LED_OUT__SLW CYREG_PRT2_SLW
...
#define CY_PROJECT_NAME "test-timer-interrupt"
