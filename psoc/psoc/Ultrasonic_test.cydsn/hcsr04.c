/* Busy wait implementation of an HC-SR04
 *
 */
#include "hcsr04.h"
#include "project.h"
...
uint32_t get_hc_sr04(){
	 ...
	 * measurements would be enough. We took measurements at 1m and 2m and
	 * got as results the values .36m and .72m respectively. We then 
