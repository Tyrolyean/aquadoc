// ======================================================================
// water_flow.v generated from TopDesign.cysch
// 05/06/2019 at 11:40
...
module top ;
    ...
    Counter_v3_0_0 water_counter (
        ...
        .up_ndown(1'b1),
        .count(Net_18));
    defparam water_counter.CaptureMode = 0;
    defparam water_counter.ClockMode = 0;
    defparam water_counter.CompareMode = 1;
    defparam water_counter.CompareStatusEdgeSense = 1;
    defparam water_counter.EnableMode = 1;
    defparam water_counter.ReloadOnCapture = 0;
    defparam water_counter.ReloadOnCompare = 0;
    defparam water_counter.ReloadOnOverUnder = 1;
    defparam water_counter.ReloadOnReset = 1;
    defparam water_counter.Resolution = 24;
    defparam water_counter.RunMode = 0;
    defparam water_counter.UseInterrupt = 1;

	wire [0:0] tmpOE__Counter_net;
	wire [0:0] tmpIO_0__Counter_net;
	wire [0:0] tmpINTERRUPT_0__Counter_net;
	electrical [0:0] tmpSIOVREF__Counter_net;
	...
	cy_psoc3_pins_v1_10
		...
		Counter
		 (.oe(tmpOE__Counter_net),
		  .y({1'b0}),
		  .fb({Net_18}),
		  .io({tmpIO_0__Counter_net[0:0]}),
		  .siovref(tmpSIOVREF__Counter_net),
		  .interrupt({tmpINTERRUPT_0__Counter_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Counter_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
