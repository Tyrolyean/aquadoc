// ======================================================================
// Battery_Alarm.v generated from TopDesign.cysch
// 03/25/2019 at 10:19
...
module top ;
	...
	wire [0:0] tmpOE__BatteryAlarm_net;
	wire [0:0] tmpFB_0__BatteryAlarm_net;
	wire [0:0] tmpIO_0__BatteryAlarm_net;
	wire [0:0] tmpINTERRUPT_0__BatteryAlarm_net;
	electrical [0:0] tmpSIOVREF__BatteryAlarm_net;
	...
	cy_psoc3_pins_v1_10
		...
		BatteryAlarm
		 (.oe(tmpOE__BatteryAlarm_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BatteryAlarm_net[0:0]}),
		  .io({tmpIO_0__BatteryAlarm_net[0:0]}),
		  .siovref(tmpSIOVREF__BatteryAlarm_net),
		  .interrupt({tmpINTERRUPT_0__BatteryAlarm_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BatteryAlarm_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("99753856-08cb-44c7-9d7c-846132d0f7a3"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
